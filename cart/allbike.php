        ...
        <div class="container-fluid px-0">
          ...
          <div class="row mx-0" style="margin-top: 80px;">
            ...
            <div class="content  col-xl-5 text-black" >
              <h1 >ALL TYPES OF BICYCLES</h1>
              <p > 
                When it comes to traversing any type of terrain, there is a versatile type of bicycle that can handle it all—the all-terrain bike. These bicycles are designed to conquer various surfaces, from smooth city streets to rugged off-road trails and everything in between. With their robust construction and adaptable features, all-terrain bikes offer the freedom to explore any landscape.

All-terrain bikes are equipped with durable frames that provide stability and durability. They are designed to withstand the challenges of different terrains, whether it's gravel paths, uneven trails, or even paved roads. The tires on these bikes strike a balance between grip and rolling resistance, allowing riders to transition seamlessly between different surfaces.
              </p>
      ...
      <div data-aos="fade-up" data-aos-duration="3000">
          <div class="hot">
              <h2><i class='bx bxs-hot bx-fade-down bx-rotate-180'></i>BICYCLES FOR ADULTS<i
      ...
      <div class="header-handlebars" data-aos="fade-right" data-aos-easing="linear"
...
?>
  ...
  <div class="container-fluid">
    ...
    $sql .= " WHERE vehicle_type = 'Sport bicycle'";
      ...
      if ($result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
              ...
              if (floatval($row["sale"]) != 0.00) {
                  ...
                  echo '        </span>';
                  echo '        <span class="price">$' . number_format($row["price"], 1, '.', ' ') . '</span>';
                  echo '    </div>';
              }
              echo '    <span class="discounted-price" >$' . number_format($row["discounted_price"], 1, '.', ' ') . '</span>';
              echo '</div>';
              echo '</div>';
